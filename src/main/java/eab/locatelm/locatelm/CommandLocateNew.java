...
public class CommandLocateNew extends CommandBase {
    ...
    // Helper to mimic 1.19+ ComponentUtils.wrapInSquareBrackets
    ...
    // Helper method to map user input structure ID to vanilla expected format
    ...
    public boolean checkPermission(MinecraftServer server, ICommandSender sender) {
        return sender.canUseCommand(2, this.getName()); // OP level 2
    }
